...
<footer id="footer">
    ...
    <div class="main_menu clearfix">
        ...
        <div class="container clearfix">
            <a class="logo_footer" href="<?php bloginfo('url')?>"><img src="<?php echo get_template_directory_uri();?>/img/nomad_logo.svg" width="160" alt="logo"/></a>
    ...
    <div class="infos">
        <div class="container" >
            <span>&copy; Nomad Construction <?php echo date("Y") ?><?php echo get_field('texte_footer_legal', 'option'); ?></span>
            <span class="option"><a href="http://agenceoption.com/" target="_blank"><img src="<?php echo get_template_directory_uri();?>/img/option.svg" width="80" alt="option design logo"/></a></span>
        </div>
    </div>
